  ...
  if (res.ok) {
    ...
    return (
        <div>
            ...
            <div className="p-5 border-2 border-gray-300 shadow-[0_0_20px_#93c5fd] mt-5">
                <div>Email Me</div>
                ...
                <div className="flex justify-center mt-10 " onClick={handleSubmit}>
                    <button className="w-2xl bg-gradient-to-r from-[#DB00FF] via-[#B200FF] to-[#8D00FF] py-2 rounded-lg text-white font-bold">Send</button>
                </div>
            </div>
        </div>
    )
