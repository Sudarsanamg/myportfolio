        ...
        {visible && (
          <div className="absolute backdrop-blur-md bg-black/30 w-full -m-2 py-5 px-2 text-lg">
            <div className="flex flex-col gap-2 px-5  ">
              <div
                className="hover:text-purple-400 transition 0.5s"
                onClick={() => {
                  scrollTo(aboutRef);
                  setVisible(false);
                }}
            ...
            <div>
              <div
                className="border-2 w-40 border-purple-500 rounded-2xl bg-purple-500 text-white font-bold px-3 py-1 ml-3 mt-3"
                onClick={() => {
